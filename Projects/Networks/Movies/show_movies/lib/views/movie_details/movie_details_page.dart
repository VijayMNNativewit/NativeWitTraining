                          ...
                          SizedBox(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                  ...
                                  children: <Widget>[
                                    Wrap(
                                      ...
                                      children: <Widget>[
                                        Chip(
                                          label: Text(
                                            widget.currentMovie.releaseDate
                                                .substring(0, 4)
                                                .toString(),
                                        ...
                                        Chip(
                                          label: Text(
                                            widget.currentMovie.voteAverage
                                                .toString(),
                                            style: Theme.of(context)
                                                .textTheme
                                                .subtitle2,
                                ...
                                GenreChipsGenerate(
                                  genreIds: widget.currentMovie.genreIds,
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: FutureBuilder<MovieDetails>(
                      future: NetworkApiRoutes.fetchMovieDetails(
                        widget.currentMovie.id,
                      ),
                      builder: (BuildContext context,
